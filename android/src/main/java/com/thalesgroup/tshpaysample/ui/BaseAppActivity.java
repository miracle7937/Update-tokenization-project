...
import com.thalesgroup.tshpaysample.ui.ui_util.GifImageView;
...
//        mProgressView.updateCaption(value);
        mProgressView.setGifImageResource(R.mipmap.loading_gif);
    ...
    public void displayMessageToast(final String error) {
        if (error != null) {
            CustomBottomSheet.error(this,  error);

//            DisplayMessage.show(this, error);
        }
    }
